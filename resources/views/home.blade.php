                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    SYP {{ number_format(\App\Models\Invoice::sum('total'), 2) }}
                                </h4>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h3 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    SYP {{ number_format(\App\Models\Invoice::where('value_status', 2)->sum('total'), 2) }}
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    SYP {{ number_format(\App\Models\Invoice::where('value_status', 1)->sum('total'), 2) }}
                                ...
                                <span class="text-white op-7">
                                    ...
                                    @php
                                        ...
                                        if($count_invoices1 == 0){
                                           ...
                                           echo round($count_invoices1 = 100 * $count_invoices1 / $count_all);
                                        }
                                    @endphp
                                </span>
                            </span>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    SYP {{ number_format(\App\Models\Invoice::where('value_status', 3)->sum('total'), 2) }}
    ...
    messaging
        ...
        .then(function(token) {
            ...
            $.ajax({
                ...
                error: function (err) {
                    console.log('User Chat Token Error'+ err[0]);
                },
            });
