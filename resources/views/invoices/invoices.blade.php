                        ...
                        <div class="col-xl-12">
                            <div class="card mg-b-20">
                                <div class="card-header pb-0">
                                    <a class="modal-effect btn btn-sm btn-primary" href="{{ route('create.invoices') }}" style="color: #fff">
                                        <li class="fa fa-plus">&nbsp;</li>اضافة فاتورة
                                    </a>
                                    <a class="modal-effect btn btn-sm btn-primary" href="{{ route('invoices.export') }}"
                                       style="color:#fff"><i class="fas fa-file-download"></i>&nbsp;تصدير اكسيل</a>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach($invoices as $index=>$invoice)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('getDetails.invoices',$invoice->id)}}" class="">
                                                        ...
                                                        <td>
                                                            ...
                                                            @endif
                                                            <span class="{{$class}}">{{$invoice->status}}</span>
                                                        </td>
                                                        <td>{{$invoice->note}}</td>
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div  class="dropdown-menu tx-13">
                                                                    <a class="dropdown-item"
                                                                       href=" {{ route('edit.invoice',$invoice->id) }}">
                                                                        <i class="text-danger fas fa-edit"></i>&nbsp;&nbsp;تعديل الفاتورة
                                                                    </a>
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                       href="{{route('get.paymentStatus',$invoice->id)}}"><i
