...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('update.paymentStatus',$invoices->id)}}" method="post" autocomplete="off">
                        @csrf
                        {{-- 1 --}}
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" id="status" name="status" required>
                                    ...
                                    <option @if($invoices->status === 'مدفوعة') selected @endif value="مدفوعة">مدفوعة</option>
                                    <option @if($invoices->status === 'مدفوعة جزئيا') selected @endif value="مدفوعة جزئيا">مدفوعة جزئيا</option>
                                    <option @if($invoices->status === 'غير مدفوعة') selected @endif value="غير مدفوعة">غير مدفوعة</option>
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="payment_date" placeholder="YYYY-MM-DD"
                                      value="{{$invoices->payment_date}}" type="text" required>
                            </div>
