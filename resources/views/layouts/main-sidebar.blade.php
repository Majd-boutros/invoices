				...
				<ul class="side-menu">
                    ...
                    @can('التقارير')
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                @can('تقرير الفواتير')
                                    <li><a class="slide-item" href="{{ route('reports.get') }}">تقارير الفواتير</a></li>
                                @endcan
                                @can('تقرير العملاء')
                                    <li><a class="slide-item" href="{{ route('reportsCustomers.get') }}">تقارير العملاء</a></li>
                                @endcan
                            </ul>
                        </li>
                    @endcan
                    @can('الاعدادات')
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                @can('المنتجات')
                                    <li><a class="slide-item" href="{{ route('get.sections') }}">الاقسام</a></li>
                                @endcan
                                @can('الاقسام')
                                    <li><a class="slide-item" href="{{ route('get.products') }}">المنتجات</a></li>
                                @endcan
                            </ul>
                        </li>
                    @endcan
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                @can('قائمة المستخدمين')
                                    <li><a class="slide-item" href="{{ route('users.get') }}">قائمة المستخدمين</a></li>
                                @endcan
                                @can('صلاحيات المستخدمين')
                                    <li><a class="slide-item" href="{{ route('roles.get') }}">صلاحيات المستخدمين</a></li>
                                @endcan
                            </ul>
                        </li>
                    @endcan
