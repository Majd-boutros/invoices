                            ...
                            <div class="card-header pb-0">
                                <div class="d-flex justify-content-between">
                                    <div class="col-sm-6 col-md-3">
                                        <button class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#exampleModal">اضافة منتج</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{route('store.products')}}" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref">المنتج</label>
